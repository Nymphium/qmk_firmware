...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LSHIFT] = LAYOUT_moonlander(
        _______, _______, _______, _______, _______, _______, _______,                         _______, _______, _______, JP_LCBR, JP_RCBR, _______, _______,
        _______, _______, JP_ASTR, _______, JP_COLN, JP_TILD,     KC_7,                        _______, _______, _______,   KC_LT,   KC_GT, _______, _______,
